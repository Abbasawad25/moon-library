<?php 
 ...
 ?>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-top clearfix">
                                <h4 class="pull-left"><?php echo $lang['the_most_recent'] ;?> <a href="#"><i class="fa fa-rss"></i></a></h4>
                            </div><!-- end blog-top -->
    ...
    $search_keyword = $tag;
     ...
     define("ROW_PER_PAGE",$view_reviews);
require_once('db.php');
	...
	?>
        <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        ...
                                        <h4 dir="auto"><a href="single.php?id=<?php echo $row['id'] ;?>&title=<?php echo $row['title'];?>" title="<?php echo $row['title'];?>"><?php echo $row['name'] ;?></a></h4>
