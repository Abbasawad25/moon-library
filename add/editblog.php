...
$a = $_POST['reg_user'];
 ...
 $section = filter_var($section,FILTER_SANITIZE_NUMBER_INT);            
	...
	//uploadbook
		...
		$sql = "UPDATE blog set title='$title_blog',title_blog='$title_short',summary='$summary',content='$subject',tag='$tag',keywords='$keywords',image='$imgName',cat_id='$categories',section='$section' where id='$idpost' ";
