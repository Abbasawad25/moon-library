...
/* if ($result->num_rows >= 0) {
  ...
  while($row = $result->fetch_assoc()) { */
  	?>
<div class="modal fade" id="view<?=$row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" dir="auto">
...
<?php echo $lang['You-will-find-here-all-the-computer-programming-and-courses'] ?>
    ...
    <!-- Modal REPLY -->
    <div class="modal fade" id="ex<?= $row['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" dir="rtl">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo $lang['name'] ?> : <?= $row['name'] ?> <br> <br>
                     <?php echo $lang['email'] ?>: <?= $row['email'] ?> <br> <br>
