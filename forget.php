...
$pas = $_POST['password'];
$pasd = md5($pas);
 $query = "UPDATE users set password='$pasd' where id='$id' ";
  
if(mysqli_query($conn, $query))
{
$_SESSION['username'] = $username;
 array_push($errors, $lang["the-password-has-been-successfully-changed"]);
 ?><script>alert("the-password-has-been-successfully-changed")</script>
 <?php
      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          <div class="text-center mb-4">
            ...
            <p><?php echo $eo;?></p>
            <p><?php echo $lang['enter-Verification-and-password'] ;?></p>
          </div>
          <form method="post" action="">
            ...
            <div class="form-group">
            	<label for="inputEmail"><?php echo $lang['the-new-password'] ;?></label>
              <div class="form-label-group">
                <input type="text" id="inputEmail" class="form-control" placeholder="<?php echo $lang['enter-new-password'] ;?>" name="password">
