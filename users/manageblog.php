...
<?php
 ...
 $idstatus = $_GET['ids'];
	...
	$user_check_query = "SELECT * FROM blog WHERE id='$idcate' LIMIT 1";
...
//delet category
if(isset($_GET['delet'])){   
   $q="DELETE FROM blog where id=".$_GET['delet'];
            ...
            <div class="card-body">
                <div class="adv-table">
                    <table  class="display table table-bordered table-striped table-hover" id="dynamic-table">
                        ...
                        <?php
                        $sql = "SELECT * FROM blog  where iduser='$iduser' ORDER BY id DESC limit 40";
...
?>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="../viewblog.php?id=<?php echo $row['id'] ;?>&<?php echo $row['title_blog'] ;?>" class="btn btn-sm btn-primary" value="2" data-toggle="modal" data-target="<?php echo  $row['id']?>"><i class="fa fa-eye"></i><?php echo $lang['view'] ?></a>
...
?>
    ...
    <?php
$sql = "SELECT * FROM blog   where iduser='$iduser' ORDER BY id DESC limit 4000";
$result = $conn->query($sql);
$siteData = mysqli_fetch_assoc($result);
if($result = mysqli_query($conn, $sql)){
            	    if(mysqli_num_rows($result) > 0){
