...
<?php
  ...
  if($role == 1 OR $role == 2){
  	if(isset($iddelet)){   
   $q="DELETE FROM book where id='$iddelet' ";
...
<?php echo $lang['All-posts'] ?> <span style="color: red"><b></b></span>
    ...
    $search_keyword = $tag;
     ...
     define("ROW_PER_PAGE",5000);
require_once('../db.php');
	$sql =' SELECT * FROM book WHERE id LIKE :keyword OR username LIKE :keyword OR view LIKE :keyword OR name LIKE :keyword OR tag LIKE :keyword OR keywords LIKE :keyword OR summary LIKE :keyword OR author LIKE :keyword  ORDER BY id DESC ';
...
?>
                                ...
                                <td class="text-center">
                                    ...
                                    if($row['type'] == 1) { ?>
                                        ...
                                        <a href="managebook.php?adspro=<?= $row['id']?>&type=0" class="btn btn-sm btn-dark"><i class="fa  fa-hand-o-down"></i><?php echo $lang['normal'] ?></a>
                                    <?php  }else{ ?>
                                        <a href="managebook.php?adspro=<?= $row['id']?>&type=1" class="btn btn-sm btn-secondary"><i class="fa  fa-hand-o-up"></i><?php echo $lang['special'] ?></a>
                                    <?php } ?>
