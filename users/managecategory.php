...
?>
	...
	$user_check_query = "SELECT * FROM categories WHERE id='$idcate' LIMIT 1";
...
//delet category
if(isset($_GET['delet'])){   
   $q="DELETE FROM categories where id=".$_GET['delet'];
    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header">
                <h3 style="display: inline-block;margin-right: 25px;"><?php echo $lang['all_category'] ;?></h3>
                <span><b></b></span>
                ...
                <div class="table-responsive" tabindex="1" style="overflow: hidden; outline: none;">
                    <table class="table table-bordered table-hover">
                       ...
                       // require_once '../vendor/autoload.php';
                        $sql = "SELECT * FROM categories  where iduser='$iduser' ORDER BY id DESC limit 10000";
...
echo $sec['name']?></td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="managecategory.php?delet=<?= $row['id']?>" class="btn btn-sm btn-danger" onclick="return confirm('<?php echo $lang['Are-you-sure'] ?>')"><i class="fa fa-trash-o"></i><?php echo $lang['Delete'] ?></a>
                                </td>
                            </tr>
                          <?php
  }
...
<?php $sql = "SELECT * FROM categories where iduser='$iduser' ORDER BY id DESC limit 10000";
$result = $conn->query($sql);
$siteData = mysqli_fetch_assoc($result);
if($result = mysqli_query($conn, $sql)){
            	    if(mysqli_num_rows($result) > 0){
