...
if(mysqli_query($conn, $query))
{
                      ...
                      $title = $code . "هو رمز إستيراد حسابك على ون بلس";
                   $seemail = $_POST['seemail'];
                   $content = "لقد تلقينا طلبًا لإعادة تعيين كلمة السر الخاصة بك على منصة مكتبة موون'
                ...
                <tr>
                  ...
                  <td>
                    <div style="border:thin solid rgb(218,220,224);border-top-left-radius:8px;border-top-right-radius:8px;border-bottom-right-radius:8px;border-bottom-left-radius:8px;padding:40px 20px" align="center">
                      <img src="http://moon-library.kesug.com/book/logo.png" width="140" aria-hidden="true" style="margin-bottom:16px" alt="moon" class="CToWUd" data-bit="iit">
                      <div style="font-family:&quot;Google Sans&quot;,Roboto,RobotoDraft,Helvetica,Arial,sans-serif;border-bottom-width:thin;border-bottom-style:solid;line-height:32px;padding-bottom:24px;text-align:center;word-break:break-word;border-bottom-color:rgb(218,220,224);color:rgba(0,0,0,0.87)">
                        <div style="font-size:24px;font-family:&quot;Google Sans&quot;,Roboto,RobotoDraft,Helvetica,Arial,sans-serif">' .$_SESSION['codes'].'  '.$_POST['title'].'</div>
                        <p><p>
                      ...
                      <div style="padding-top:20px;font-size:12px;line-height:16px;letter-spacing:0.3px;text-align:center;color:rgb(95,99,104)"><p>
لقد تلقينا طلبًا لإعادة تعيين كلمة السر الخاصة بك  على منصة موون  الرمز</p>'.$_SESSION['codes'].'<br>
...
function send_email($username, $password, $sender_name, $to, $subject, $title, $text) {
   ...
   try {
      ...
      $email = $to;
      $logo = "http://moon-library.kesug.com/book/images/lgo.png";
      $site_name = "منصة مكتبة موون";
  ...
  <body  class="bg-dark"  >
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        <div class="card-header"><?php echo $lang['reset-password'];?></div>
        <div class="card-body">
          <div class="text-center mb-4">
            <h4><?php echo $lang['Forgot-your-password'];?></h4>
            <p><?php echo $lang['Enter-your-email-address-and-we'];?></p>
          </div>
...
$subject = " مرحبا بك " . $ro['name'] . " لقد طلبت تغيير كلمة السر ";
